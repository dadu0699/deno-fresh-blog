...
export default function PagePost(props: PageProps) {
  ...
  return (
    <>
      ...
      <Body>
        <article class="flex-grow container md:max-w-3xl px-4 pt-16 mx-auto">
          <section class="fixed top-0 left-0 p-4 z-50 min-w-full bg-white md:bg-white dark:bg-gray-900 dark:md:bg-gray-900">
            <a
